...
public class PartyMember extends SecondaryLivingCreature       //not tested. check before use.
{
	...
	private final HpConstants petHpConstants;

	public boolean exist()
	{
		if (L2Window.colorsAreClose(
								   l2Window.getRelPixelColor(
															new Point(hpConstants.coordinateLeft.x - 6, hpConstants.coordinateLeft.y)),
	...
	public int getHP(Object o)    //overloaded
	{
	...
	public PartyMember(L2Window l2Window, PartyMember higherMember)
	{
		super(ID_PartyMember, l2Window);
		logger.trace("creating PartyMember in window" + l2Window);
