...
public class TempleKnight extends Character
{
	...
	private final        Character.ActionBuff                //second parameter is numpad key number
								summonLifeCubic = new Character.ActionBuff("Life Cube", 1, (15 * 60) * 1000, 0),
	summonStormCubic                            = new Character.ActionBuff("Storm Cube", 2, (15 * 60) * 1000, 0),    //todo:what's the time?
	summonAttractCubic                          = new Character.ActionBuff("Attract Cube", 3, (15 * 60) * 1000, 0);
...
//		for (Map.Entry<Character.ActionBuff, Timer> buffTimerEntry : this.buffTimerMap.entrySet()) {
